...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherClock = __webpack_require__(168);
	var Autocomplete = __webpack_require__(171);
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Widgets, null), document.getElementById("root"));
	});
	var Widgets = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Tabs, { items: [{ title: "Cat", content: "I'm a kitty kat" }, { title: "Dog", content: "I'm better than a cat" }, { title: "Turtle", content: "My name is Franklin" }] }),
	      React.createElement(WeatherClock, null),
	      React.createElement(Autocomplete, { items: ['grizabella', 'tofina', 'alfred', 'germina', 'yurbelle'] })
	    );
	  }
	});
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.items.map(function (item, idx) {
	          ...
	          return React.createElement(Header, { key: idx, estilo: estilo, title: item.title, onClick: ziji.clicked.bind(ziji, idx) });
	        })
	      ),
	      React.createElement(
	        'article',
	        null,
	        this.props.items[seleccionado].content
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'h1',
	      { className: this.props.estilo, key: this.key, onClick: this.props.onClick },
	      this.props.title
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = __webpack_require__(170);
	...
	var Autocomplete = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      "div",
	      null,
	      React.createElement("input", { type: "text", onInput: this.written }),
	      React.createElement(
	        "ul",
	        null,
	        " ",
	        matchedStrings.map(function (str) {
	          return React.createElement(
	            "li",
	            null,
	            str
